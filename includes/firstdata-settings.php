...
/**
 * Settings for First Data Gateway.
 */
return array(
    'country' => array(
    ...
    'logo' => array(
        ...
        'label' => __('Display Logo <img src="' . $this->checkLogo() . '" style="float: left; margin-top:-10px; margin-right:10px;" id="fd-plugin-logo"/>', $this->id),
    ...
    'authorization' => array(
        ...
        'description' => __('If "Hosted Page" is chosen, the customer will be redirected to a secure payment page hosted by First Data Gateway to enter their payment details. If "Hidden Authorisation" is chosen, you will host the initial payment page on your site.', $this->id),
        'default' => 'hosted',
        'desc_tip' => true,
        'options' => array(
