...
/**
 * Generates requests to send to Firstdata.
 */
class Firstdata_Request {
    ...
    public function build_request($request = null) {
        ...
        curl_close($ch);
        require_once( dirname(__FILE__) . '/firstdata-response.php' );
        $process_response = new Firstdata_Response();
