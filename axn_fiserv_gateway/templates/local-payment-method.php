<?php
$firstData = new axn_Axn_fiserv_Gateway();
$html = "<option value=''>--".__('Please Select', 'woocommerce-axn_fiserv')."--</option>";
...
<div id="credit-card" class="wc-payment-form local-payment-form">
    ...
    <p style='padding-top: 30px;'>
        ...
        <span><?php _e('Use Local/Alternate Payment Method', 'woocommerce-axn_fiserv') ?></span>
    </p>
    <div id="_localpayment_details" style="display:none;">
        <fieldset id="wc-axn_fiserv_gateway-cc-form">
            <p class="form-row form-row-wide woocommerce-validated">
                <label for="axn_fiserv_gateway-card-number" style="width:40%;float:left;
                       padding-top: 10px;"><?php _e('Choose Your Local Methods :', 'woocommerce-axn_fiserv') ?></label>
